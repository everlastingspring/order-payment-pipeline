...
/**
 * Kafka producer infrastructure configuration for inventory-service.
 *
 * <p>Identical strong-durability settings as all other services: {@code acks=all},
 * {@code retries=3}, {@code enable.idempotence=true}, {@code max.in.flight=1}.
 * OTel observation is enabled for distributed tracing.</p>
 *
 * <p>Inventory-service produces {@code inventory.reserved} and {@code inventory.failed}
